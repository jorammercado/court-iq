    ...
    <section id="three" ref={ref} className="main style2 left dark fullscreen">
      <MoveInWhenVisible>
        ...
        >
          ...
          <h5>
            Discover much more than what your average sports statistics site offers. <br></br>
            <br></br>
            <span style={{ color: '#EA6607' }}>Select</span> the stats you want to see or compare,
            and
            <span style={{ color: '#EA6607' }}> &nbsp; Zoom In/Out</span> to focus on your specific
            range of interest (double click to zoom back out).
          </h5>
        </div>
      </MoveInWhenVisible>
