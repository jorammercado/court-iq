    ...
    const fetchPlayerProps = async (eventId) => {
      ...
      try {
        const response = await axios.get(
          `https://api.the-odds-api.com/v4/sports/basketball_wnba/events/${eventId}/odds`,
          {
            params: {
              apiKey,
              regions: 'us',
              markets: 'player_points,player_rebounds,player_assists,player_threes,player_blocks',
              oddsFormat: 'american',
            },
          }
        )
        ...
        if (
          ...
          response.data.bookmakers[0].markets &&
          response.data.bookmakers[0].markets[0] &&
            ...
            return {
              ...
              lastUpdate:
                bookmaker.markets && bookmaker.markets.length > 0
                  ? bookmaker.markets[1].last_update
                  : 'No update',
              playerProps:
                bookmaker.markets && bookmaker.markets.length > 0
                  ? bookmaker.markets[1].outcomes
                  : [],
            }
          })
        ...
        } else throw new Error('No Props or betting closed')
      } catch (error) {
        console.error(error)
      } finally {
        setIsLoading(false)
              ...
              >
                <TableBuilderColumn header="Bookmaker">
                  {(row) => {
                    ...
                    if (isPointsBet) bookmakerUrl = 'https://www.pointsbet.com'
                    if (isBetOnline) bookmakerUrl = 'https://www.betonline.ag'
                    ...
                    if (isDraftKings) {
                      imageContent = (
                        <img
                          width="18"
                          height="18"
                          src="https://img.icons8.com/color-glass/48/medieval-crown.png"
                      ...
                      imageContent = (
                        <svg
                          ...
                          style={{
                            enableBackground: 'new 0 0 5000 5000',
