          ...
          const leadersWithCategory = [
            {
              ...sortedPoints[0],
              category: 'Points',
              average: calculateAverage(sortedPoints[0].points, sortedPoints[0].games),
            },
            {
              ...sortedAssists[0],
              category: 'Assists',
              average: calculateAverage(sortedAssists[0].assists, sortedAssists[0].games),
            },
            {
              ...sortedRebounds[0],
              category: 'Rebounds',
              average: calculateAverage(sortedRebounds[0].rebounds, sortedRebounds[0].games),
            },
          ].map((leader) => ({ ...leader }))
          ...
          {leaders.map((leader, index) => (
            ...
            >
              ...
              >
                ...
                >
                  {`${leader.firstname} ${leader.lastname}`.length < 14 && screenWidth > 365
                    ? `${leader.firstname} ${leader.lastname}`
                    : `${leader.lastname}`}
                </StyledTitle>

                <StyledThumbnail
                  src={playerImages[index] || 'https://via.placeholder.com/150'}
                  style={{
                    height:
                      screenWidth > 870
                        ? '190px'
                  ...
                  <HeadingLevel>
                    ...
                    >
                      ...
                      <span
                        style={{
                          fontSize:
                            screenWidth > 870 ? '15px' : screenWidth > 494 ? '14px' : '13px',
                        }}
                      >
                        {leader.average}
                      </span>
