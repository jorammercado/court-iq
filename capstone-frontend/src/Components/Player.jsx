...
function PlayerExample({ data, playerid }) {
  ...
  function selectPrimaryColor(referenceData) {
    if (referenceData && referenceData.team)
      for (let i = 0; i < teams.length; i++) {
        if (teams[i] === referenceData.team.name) return primaryColors[i]
      }
    return '#EA6607'
  }
  ...
  function selectSecondaryColor(referenceData) {
    if (referenceData && referenceData.team)
      for (let i = 0; i < teams.length; i++) {
        if (teams[i] === referenceData.team.name) return secondaryColors[i]
      }
    return '#000000'
  }
  ...
  const calculateTotalBlocksForSeason = (playerStats) => {
    ...
    const totalBlocks = playerStats.reduce((total, stat) => total + parseInt(stat.blocks || 0), 0)
    return totalBlocks
  }
  ...
  const calculateTotalAssistsForSeason = (playerStats) => {
    ...
    const totalAssists = playerStats.reduce((total, stat) => total + parseInt(stat.assists || 0), 0)
    return totalAssists
  }
  ...
  const calculateTotalPointsForSeason = (playerStats) => {
    ...
    const totalPoints = playerStats.reduce((total, stat) => total + parseInt(stat.points || 0), 0)
    return totalPoints
  }
  ...
  const getLastGames = () => {
    ...
    if (gamesInView === '5') return copyStats.slice(0, 5)
    else if (gamesInView === '10') return copyStats.slice(0, 10)
    else if (gamesInView === '20') return copyStats.slice(0, 20)
    else if (gamesInView === '50') return copyStats.slice(0, 50)
    else if (gamesInView === 'season') return copyStats.slice(0)
  }
        ...
        >
          ...
          >
            ...
            <Block
              ...
              $style={{
                flexGrow: 3,
                ...(screenWidth <= 445 && screenWidth > 420
                  ? { lineHeight: '1', paddingBottom: '15px' }
                  : screenWidth <= 420
                    ? { lineHeight: '0.5', paddingBottom: '30px' }
                    : {}),
              }}
            >
              {screenWidth > 420 ? (
                <HeadingLevel>
                  <Heading styleLevel={screenWidth > 1120 ? 2 : 3} color={secondaryColor}>
                    {' '}
                    <span
                      style={{
                        ...(screenWidth < 1110 && screenWidth > 945
                          ? { fontSize: '31px' }
                          : screenWidth <= 945 && screenWidth > 935
                            ? { fontSize: '30px' }
                            : screenWidth <= 935 && screenWidth > 925
                              ? { fontSize: '29px' }
                              : screenWidth <= 925 && screenWidth > 915
                                ? { fontSize: '28px' }
                                : screenWidth <= 915 && screenWidth > 795
                                  ? { fontSize: '27px' }
                                  : screenWidth <= 795 && screenWidth > 785
                                    ? { fontSize: '26px' }
                                    : screenWidth <= 785 && screenWidth > 775
                                      ? { fontSize: '25px' }
                                      : screenWidth <= 775 && screenWidth > 720
                                        ? { fontSize: '24px' }
                                        : screenWidth <= 720 && screenWidth > 710
                                          ? { fontSize: '23px' }
                                          : screenWidth <= 710 && screenWidth > 670
                                            ? { fontSize: '22px' }
                                            : screenWidth <= 670 && screenWidth > 635
                                              ? { fontSize: '21px' }
                                              : screenWidth <= 635 && screenWidth > 625
                                                ? { fontSize: '20px' }
                                                : screenWidth <= 625 && screenWidth > 614
                                                  ? { fontSize: '19px' }
                                                  : screenWidth <= 614 && screenWidth > 545
                                                    ? { fontSize: '18px' }
                                                    : screenWidth <= 545 && screenWidth > 535
                                                      ? { fontSize: '17px' }
                                                      : screenWidth <= 535 && screenWidth > 525
                                                        ? { fontSize: '16px' }
                                                        : screenWidth <= 525 && screenWidth > 505
                                                          ? { fontSize: '15px' }
                                                          : screenWidth <= 505 && screenWidth > 445
                                                            ? { fontSize: '14px' }
                                                            : screenWidth <= 445 && screenWidth > 0
                                                              ? { fontSize: '13px' }
                                                              : {}),
                  ...
                  <Heading styleLevel={screenWidth > 1155 ? 5 : 6} color={secondaryColor}>
                    <span
                      style={{
                        ...(screenWidth <= 1085 && screenWidth > 955
                          ? { fontSize: '19px' }
                          : screenWidth <= 955 && screenWidth > 935
                            ? { fontSize: '18px' }
                            : screenWidth <= 935 && screenWidth > 920
                              ? { fontSize: '17px' }
                              : screenWidth <= 920 && screenWidth > 790
                                ? { fontSize: '16px' }
                                : screenWidth <= 790 && screenWidth > 710
                                  ? { fontSize: '15px' }
                                  : screenWidth <= 710 && screenWidth > 640
                                    ? { fontSize: '14px' }
                                    : screenWidth <= 640 && screenWidth > 480
                                      ? { fontSize: '13px' }
                                      : screenWidth <= 480 && screenWidth > 445
                                        ? { fontSize: '12px' }
                                        : screenWidth <= 445 && screenWidth > 0
                                          ? { fontSize: '11px' }
                                          : {}),
                    ...
                    >
                      ...
                      &nbsp;
                      {personalData && personalData.leagues && personalData.leagues.standard
                        ? '#' + personalData.leagues.standard.jersey
                        : ''}{' '}
                      &nbsp;
                ...
                <Block $style={{ marginBottom: '5px' }}>
                  <LabelXSmall color={secondaryColor}>
                    {' '}
                    {data.firstname} {data.lastname}{' '}
                  </LabelXSmall>
                </Block>
              ...
              <Block display="flex" justifyContent="space-around" width="60%">
                {screenWidth > 825 ? (
                  ...
                  <>
                    <LabelXSmall color={secondaryColor}>
                      {' '}
                      <span style={{ ...(screenWidth <= 490 ? { fontSize: '10px' } : {}) }}>
                        {' '}
                        PPG{' '}
                      </span>
                    </LabelXSmall>{' '}
              ...
              <Block display="flex" justifyContent="space-around" width="60%">
                {screenWidth > 825 ? (
                  <>
                    ...
                    &nbsp; &nbsp;
                    <LabelLarge color={secondaryColor}>
                      {calculateAverageReboundsPerGame()}
                    </LabelLarge>{' '}
                    &nbsp; &nbsp;
                    <LabelLarge color={secondaryColor}>
                      {calculateAverageAssistsPerGame()}
                    </LabelLarge>{' '}
                    &nbsp; &nbsp;
                  ...
                  <>
                    <LabelMedium color={secondaryColor}>
                      {calculateAveragePointsPerGame()}
                    </LabelMedium>
                    &nbsp; &nbsp;
                    <LabelMedium color={secondaryColor}>
                  ...
                  <>
                    <LabelSmall color={secondaryColor}>
                      <span
                        style={{
                          ...(screenWidth <= 720 && screenWidth > 645
                            ? { fontSize: '12px' }
                            : screenWidth <= 645 && screenWidth > 600
                              ? { fontSize: '11px' }
                              : screenWidth <= 600 && screenWidth > 490
                                ? { fontSize: '10px' }
                                : screenWidth <= 490
                                  ? { fontSize: '9px' }
                                  : {}),
                ...
                overrides={{
                  ...
                  Root: {
                    style: ({ $theme }) => ({
                      ...
                      marginTop:
                        screenWidth <= 901 && screenWidth > 780
                          ? '25px'
                          : screenWidth <= 780 && screenWidth > 700
                            ? '45px'
                            : screenWidth <= 700 && screenWidth > 615
                              ? '65px'
                              : screenWidth <= 615 && screenWidth > 505
                                ? '90px'
                                : screenWidth <= 505 && screenWidth > 445
                                  ? '110px'
                                  : screenWidth <= 445 && screenWidth > 420
                                    ? '130px'
                                    : screenWidth <= 420 && screenWidth > 370
                                      ? '145px'
                                      : screenWidth <= 370 && screenWidth > 0
                                        ? '175px'
                                        : '0px',
                    }),
                  },
          ...
          <Block className="middle" marginLeft="-10px" marginRight="-10px">
              ...
              {screenWidth > 800 ? (
                ...
                <HeadingXSmall
                  ...
                  $style={{
                    ...
                    zIndex: '0',
                    transition: 'background-color 0.5s ease-in-out',
                    ...(screenWidth <= 460 && screenWidth > 380
                      ? { fontSize: '15px' }
                      : screenWidth <= 380
                        ? { fontSize: '14px' }
                        : {}),
                ...
                <Table
                  ...
                  data={[
                    [
                      selectedSeason,
                      (
                        minutes.map((e) => Number(e)).reduce((tot, curr) => tot + curr, 0) /
                        minutes.length
                      ).toFixed(2),
                      (
                        points.map((e) => Number(e)).reduce((tot, curr) => tot + curr, 0) /
                        points.length
                      ).toFixed(2),
                      (
                        rebounds.map((e) => Number(e)).reduce((tot, curr) => tot + curr, 0) /
                        rebounds.length
                      ).toFixed(2),
                      (
                        assists.map((e) => Number(e)).reduce((tot, curr) => tot + curr, 0) /
                        assists.length
                      ).toFixed(2),
                      (
                        steals.map((e) => Number(e)).reduce((tot, curr) => tot + curr, 0) /
                        steals.length
                      ).toFixed(2),
                      (
                        blocks.map((e) => Number(e)).reduce((tot, curr) => tot + curr, 0) /
                        blocks.length
                      ).toFixed(2),
                      (
                        turnovers.map((e) => Number(e)).reduce((tot, curr) => tot + curr, 0) /
                        turnovers.length
                      ).toFixed(2),
                      (
                        fgp.map((e) => Number(e)).reduce((tot, curr) => tot + curr, 0) / fgp.length
                      ).toFixed(2),
                      (
                        tpp.map((e) => Number(e)).reduce((tot, curr) => tot + curr, 0) / tpp.length
                      ).toFixed(2),
                      (
                        ftp.map((e) => Number(e)).reduce((tot, curr) => tot + curr, 0) / ftp.length
                      ).toFixed(2),
                      dd,
                      td,
                    ],
            ...
            >
              ...
              >
                {screenWidth > 570 ? (
                  <HeadingSmall
                    backgroundColor={isHighlightedGames ? '#EA6607' : 'black'}
                    $style={{
                      color: 'white',
                      backgroundColor: isHighlightedGames ? '#EA6607' : 'black',
                      transition: 'background-color 0.5s ease-in-out',
                ...
                <Table
                  ...
                  data={getLastGames().map((game, index) => {
                    ...
                    if (games.length > 0 && games && games[index] && games[index].date) {
                      return [
                        lastAllGames.length - index,
                        games[index].date.start.split('T')[0].replace(/[-]/g, '/'),
                          ...
                          referenceData.team ? (
                            games[index].teams.home ? (
                              referenceData.team.name === games[index].teams.home.name ? (
                                games[index].teams.visitors.nickname.replace(/[\s]/g, '') +
                                ' ' +
                                games[index].teams.visitors.code
                              ) : (
                                games[index].teams.home.nickname.replace(/[\s]/g, '') +
                                ' ' +
                                games[index].teams.home.code
                              )
                            ) : (
                        ...
                        `${
                          referenceData.team ? (
                            games[index].teams.home ? (
                              referenceData.team.name === games[index].teams.home.name ? (
                                games[index].scores.home.points +
                                '-' +
