...
const glossaryItems = [
    ...
    { acronym: 'DD', description: 'Double-Double (achieving double digits in two statistical categories in a single game)' },
    { acronym: 'TD', description: 'Triple-Double (achieving double digits in three statistical categories in a single game)' },
    ...
    { acronym: '+/-', description: 'Plus/Minus (the point differential when a player is on the court)' },
