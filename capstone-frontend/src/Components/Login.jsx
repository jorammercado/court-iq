...
import { signInWithGoogle, signInAnon, signInWithFacebook } from '../Services/FireBase'
import './Login.scss'
import 'animate.css'
...
export const Login = ({ currentUser, setCurrentUser, photoURL, setPhotoURL }) => {
                  ...
                  <StyledBody>
                    <Wrapper>
                      <StyledButtons>
                        ...
                        <button
                          onClick={signInAnon}
                          className="btn btn-light btn-lg login__button animate__animated animate__fadeInUp"
                          style={{ borderRadius: '3px', margin: '4px' }}
                        >
                          Continue as Guest
                        </button>
                      </StyledButtons>
