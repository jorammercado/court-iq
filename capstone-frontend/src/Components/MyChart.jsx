  ...
  useEffect(() => {
    ...
    var margin = { top: 60, right: 115, bottom: 50, left: 50 },
      width =
        (screenWidth > 1360
          ? 770
          : screenWidth <= 1360 && screenWidth > 1280
            ? 1250
            : screenWidth <= 1280 && screenWidth > 1215
              ? 1150
              : screenWidth <= 1215 && screenWidth > 1165
                ? 1100
                : screenWidth <= 1165 && screenWidth > 1100
                  ? 1065
                  : screenWidth <= 1100 && screenWidth > 1024
                    ? 1000
                    : screenWidth <= 1024 && screenWidth > 950
                      ? 930
                      : screenWidth <= 950 && screenWidth > 890
                        ? 870
                        : screenWidth <= 890 && screenWidth > 840
                          ? 820
                          : screenWidth <= 840 && screenWidth > 790
                            ? 770
                            : screenWidth <= 790 && screenWidth > 740
                              ? 720
                              : screenWidth <= 740 && screenWidth > 700
                                ? 680
                                : screenWidth <= 700 && screenWidth > 650
                                  ? 630
                                  : screenWidth <= 650 && screenWidth > 615
                                    ? 590
                                    : screenWidth <= 615 && screenWidth > 570
                                      ? 550
                                      : screenWidth <= 570 && screenWidth > 540
                                        ? 520
                                        : screenWidth <= 540 && screenWidth > 520
                                          ? 500
                                          : screenWidth <= 520 && screenWidth > 500
                                            ? 480
                                            : screenWidth <= 500 && screenWidth > 480
                                              ? 460
                                              : screenWidth <= 480 && screenWidth > 460
                                                ? 440
                                                : screenWidth <= 460 && screenWidth > 440
                                                  ? 420
                                                  : screenWidth <= 440 && screenWidth > 420
                                                    ? 400
                                                    : screenWidth <= 420 && screenWidth > 400
                                                      ? 380
                                                      : screenWidth <= 400 && screenWidth > 380
                                                        ? 360
                                                        : screenWidth <= 380 && screenWidth > 370
                                                          ? 355
                                                          : 330) -
        margin.left -
        margin.right,
    ...
    var color = d3
      ...
      .domain(keys)
      .range(
        ['#EA6607', '#EFA996', '#EE8F79', '#ED855D', '#EC7B40', '#EB7124', '#EA6607'].reverse()
      )
    ...
    var yAxis = svg.append('g').call(d3.axisLeft(y).ticks(10))
    ...
    svg.append('g').attr('class', 'brush').call(brush).call(brush.move, [0, width]) // Initially show the full chart
