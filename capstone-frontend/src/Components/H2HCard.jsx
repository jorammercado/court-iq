...
const Card = ({ homeTeam, awayTeam, odds, data, homeLogo, awayLogo, bookmaker, sport }) => {
  ...
  const findBackgroundColor = (team1, team2) => {
    ...
    const color1 =
      index1 !== -1
        ? sport === 'NBA'
          ? primaryColors[index1]
          : primaryColorsWNBA[index1]
        : 'black'
    const color2 =
      index2 !== -1
        ? sport === 'NBA'
          ? primaryColors[index2]
          : primaryColorsWNBA[index2]
        : 'black'
  ...
  const formatDate = (dateString) => {
    ...
    const isDst = (date) => {
      const marSecondSunday = new Date(
        date.getFullYear(),
        2,
        14 - new Date(date.getFullYear(), 2, 1).getDay()
      )
      const novFirstSunday = new Date(
        date.getFullYear(),
        10,
        7 - new Date(date.getFullYear(), 10, 1).getDay()
      )
  ...
  const textStyle = {
    fontSize:
      screenWidth <= 1080 && screenWidth > 1015
        ? '14px'
        : screenWidth > 915
          ? '14px'
          : screenWidth > 715
  ...
  return (
    <div
      ...
      style={{
        display: 'flex',
        flexDirection: 'row',
        margin: screenWidth > 425 ? '10px' : '5px',
        border: 'solid #EA6607 3px',
        textAlign: 'center',
        borderRadius: '8px',
      }}
    >
              ...
              height:
                screenWidth > 1015
                  ...
                  : screenWidth > 825
                    ...
                    : screenWidth > 755
                      ? '180px'
                      : screenWidth > 715 && screenWidth <= 755
                        ? '255px'
                        : screenWidth > 605
                          ? '210px'
                          : screenWidth > 565
        ...
        >
          <img
            ...
            style={{
              ...
              ...(screenWidth <= 1305 && screenWidth > 715
                ? { marginRight: '25px' }
                : screenWidth <= 530
                  ? { marginLeft: '-14px' }
                  : screenWidth <= 565
          ...
          <div style={{ flex: '1' }}>
            <div
              style={{
                ...textStyle,
                fontSize:
                  screenWidth <= 1080 && screenWidth >= 915
                    ? '17px'
                    : screenWidth > 1015
                      ? '18px'
                      : screenWidth > 815
