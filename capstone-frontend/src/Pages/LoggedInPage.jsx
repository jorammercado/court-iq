...
export const LoggedInPage = ({ currentUser, setCurrentUser, setPhotoURL, photoURL }) => {
          ...
          <div className="animate__animated animate__fadeInDown">
            ...
            <div className="image">
              {!/[<>]/.test(photoURL) ? (
                ...
                <SVG src={photoURL} width={128} length="auto" title="avatar" />
              )}
            </div>
            <h3 className="email">
  ...
  } else return <div className="not-logged-in"> NOT LOGGED IN </div>
}
