      ...
      <Block className="player-comparison-container">
        <Block className="comparison-instruction" style={{ maxWidth: '1270px' }}>
          <HeadingLevel>
            ...
            >
              Welcome to our NBA player comparison tool! Enter the names of two NBA players below
              and click "Compare Players" to see their detailed statistics side by side.
            </Heading>
          </HeadingLevel>
        </Block>
            ...
            {player1Data && (
              ...
              >
                ...
                <Block className="info-card ">
                  ...
                  <LabelLarge className="player-stat">
                    Effective Shooting %: {player1Data.stats.effectiveShootingPercentage}
                  </LabelLarge>
                  <LabelLarge className="player-stat">
            ...
            {player2Data && (
              ...
              >
                ...
                <Block className="info-card">
                  ...
                  <LabelLarge className="player-stat">
                    Effective Shooting % : {player2Data.stats.effectiveShootingPercentage}
                  </LabelLarge>
                  <LabelLarge className="player-stat">
